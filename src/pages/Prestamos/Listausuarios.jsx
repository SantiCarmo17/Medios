...
export const ListaUsuarios = () => {
  const { data, error, loading } = useGetData(["clients"]);
  ...
  const sortedClientes = stableSort(filteredClientes, getComparator(order, orderBy));

  const emptyRows = rowsPerPage - Math.min(rowsPerPage, sortedClientes.length - page * rowsPerPage);
